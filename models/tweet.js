...
module.exports = mongoose.Schema({
	contributors: [{id: mongoose.Schema.Types.Long, screen_name: String}],
	coordinates: {coordinates: [Number], type: String},
	created_at: Date,
	current_user_retweet: {id: mongoose.Schema.Types.Long},
	entities: {hashtags: [{indices: [Number], text: String}],
		   media: [{display_url: String,
			    ...
			    source_status_id: mongoose.Schema.Types.Long,
			    type: String,
			    url: String}],
		   urls: [{indices: [Number], url: String, display_url: String, expanded_url: String}],
		   user_mentions: [{name: String, indices: [Number], screen_name: String, id: mongoose.Schema.Types.Long}]},
	favorite_count: Number,
	favorited: Boolean,
	filter_level: String,
	id: mongoose.Schema.Types.Long,
	in_reply_to_screen_name: String,
	in_reply_to_status_id: mongoose.Schema.Types.Long,
	lang: String,
	place: {attributes: {},
	...
	text: String,
	truncated: Boolean,
	user: {contributors_enabled: Boolean,
	       created_at: Date,
